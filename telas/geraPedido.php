...
<header>
  ...
  <main class="container-fluid">
      ...
      <div class="row">
       ...
       <select name="tamanho" id="tamanho" class="form-select form-select form-control">
           ...
           <label for="nome"> nome da sua pizza</label><input type="text" name="nome" id="nome" placeholder="de um nome para sua pizza"  class="form-control" require>
           </div>
           </div>
           <div class="row m-2"></div>
            <div class="col md-6">           
            <label for="descriao"> descricao da sua pizza</label> <textarea name="descricao" id="descriao"
            class="form-control descpizza" cols="30" rows="10" placeholder="digite uma descricao para sua pizza" 
             required></textarea>
            </div>
            </div>
            <div class="row mt-3">
     ...
     <div class="row mt-3">
      ...
      <label for="preco">preço a pagar</label>  <input type="text"id="preco" name="valor_pagar" class="form-control">
            ...
            <div class=" row mb-2">
                <div class="col-md-2">
        <input type="submit" value=" pedir" name="btnPedido" class=" btn btn-danger">
            </div>
                <div class ="col-md-1">
