...
if(! isset($_SESSION["logado_funcionario"])){
...
<head>
    ...
    <title>Area revaservada funcionario </title>
    <style>
         body{
        background-image: url(../imagens/AreadoFunconario.png);
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="AdminFuncionario.php">inicio</a>
        </li>
